...
exports.getUnitEdgePosition = getUnitEdgePosition;
exports.buildSegment = buildSegment;
function getUnitEdgePosition(unit, edge, nodesById) {
...
function buildSegment(now, unit, edge, nodesById) {
